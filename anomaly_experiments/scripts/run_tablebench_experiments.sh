...
QTYPES=(DataAnalysis NumericalReasoning)
QSUBTYPES=(Aggregation ArithmeticCalculation CausalAnalysis Comparison Counting Domain-Specific ImpactAnalysis Multi-hop\ NumericalReasoing Ranking StatisticalAnalysis Time-basedCalculation)
...
INPUT_FILE="${REPO_ROOT}/data/datamind_eval_inputs/tablebench_all.jsonl"
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/${MODEL_SLUG}_tablebench}"
...
EVAL_ARGS=(
  "${REPO_ROOT}/DataMind/datamind/eval/python/eval_tablebench_react.py"
  --model "${MODEL_NAME}"
